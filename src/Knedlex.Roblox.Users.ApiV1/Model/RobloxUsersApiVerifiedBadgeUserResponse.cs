...
namespace Knedlex.Roblox.Users.ApiV1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Roblox.Users.Api.VerifiedBadgeUserResponse")]
    public partial class RobloxUsersApiVerifiedBadgeUserResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RobloxUsersApiVerifiedBadgeUserResponse" /> class.
        /// </summary>
        ...
        public RobloxUsersApiVerifiedBadgeUserResponse(bool hasVerifiedBadge = default(bool), long id = default(long), string name = default(string), string displayName = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RobloxUsersApiVerifiedBadgeUserResponse {\n");
