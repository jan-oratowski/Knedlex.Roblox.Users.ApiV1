...
namespace Knedlex.Roblox.Users.ApiV1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Roblox.Users.Api.BirthdateResponse")]
    public partial class RobloxUsersApiBirthdateResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RobloxUsersApiBirthdateResponse" /> class.
        /// </summary>
        ...
        public RobloxUsersApiBirthdateResponse(int birthMonth = default(int), int birthDay = default(int), int birthYear = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RobloxUsersApiBirthdateResponse {\n");
